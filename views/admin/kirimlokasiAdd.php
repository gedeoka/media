      ...
      <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner"  style="min-height:400px;">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Kirim Lokasi</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                               ...
                               <table class="table table-striped table-bordered table-hover" id="example">
									...
									<tr>
											...
											Area : <select id="areas" class='areas' >
											<option value="0">All</option>
											<?php
												foreach ($this->areals as $key => $value){
												?>
											<option value="<?php echo $value["ID"];?>"><?php echo $value["NamaArea"];?></option>
												<?php }?>
											</select>
											</th>
                                        </tr>
...
<tr><td>							<div id="mydata" style="overflow:auto; height:350px;">
                                            		 <?php
													 $i=1;
...
$('.areas').change(function(){
		...
		//alert(dis);
		$('#mydata').empty();
		$.post("./relist",{dis:dis},function(x){
			//alert(x);
			$('#mydata').append(x);
		});
