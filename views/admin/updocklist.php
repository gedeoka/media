                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="example">
									...
									if(Code::requery("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=14")<>0){
													$del=Code::GetField("usrprev","Kirim","IDUser='".Session::get('ID')."' and IDModule=14");
									}
									if(Code::requery("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=14")<>0){
													$chg=Code::GetField("usrprev","Kirim","IDUser='".Session::get('ID')."' and IDModule=14");
									}
									foreach ($this->prolist as $key => $value) {
                                        ...
                                        <tr class="odd gradeX">
											...
											<?php
													...
													if($chg==1){?>
											<a class="btn btn-warning btn-circle" href="<?php echo URL;?>admin/updockEdit/<?php echo $value['ID']; ?>"><i class="icon-pencil"></i></a>
											<?php }?>
											<?php
													
													if($del==1){?>
											<a class="btn btn-danger btn-circle" href="<?php echo URL;?>admin/updockDel/<?php echo $value['ID']; ?>"><i class="icon-remove"></i></a>
											<?php }?>
