									...
									foreach ($this->IjinList as $key => $value) {
                                       ...
                                       <tr >
											...
											<a class="btn btn-primary btn-circle" href="<?php echo URL;?>admin/UploadImgPrinsip/<?php echo $value['ID']; ?>"><i class="icon-picture"></i></a>
												...
												<a class="btn btn-danger btn-circle" href="<?php echo URL;?>admin/Delete<?php echo $link."/". $value['ID']."-".$this->Status; ?>"><i class="icon-remove"></i></a>
												</td>
                                        </tr>
										<tr>
										<td colspan="9">
										<?php
										foreach($value["lsimg"] as $limg){
											?>
											<a  id="example3" href="<?php echo URL.$limg["Img"];?>"><img style="border:1px#999;" src="<?php echo URL.$limg["Img"];?>" height="200" width="auto" alt="" /></a>
											<?php
										}
										?>
										</td>
