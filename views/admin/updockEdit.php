                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="<?php echo URL; ?>admin/updockUpd/<?php echo $this->docklist[0]["ID"];?>" method="POST"  enctype="multipart/form-data" >
										...
										<div class="form-group">
											...
											<span class="input-group-addon"><i class="icon-calendar"></i></span>
												<input type="text" class="form-control " name="tgltayang" value="<?php echo date("m/d/Y",strtotime($this->docklist[0]["tgltayang"]))?>" id="dp1" />
											</div>
										</div>
										
										<div class="form-group">
                                            <label>Tema</label>
                                            <input class="form-control" id="tema" name="tema" value="<?php echo $this->docklist[0]["Tema"]?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Pemasang</label>
                                            <input class="form-control" id="pemasang" value="<?php echo $this->docklist[0]["pemasang"]?>" name="pemasang">
                                        </div>
										...
										<div class="form-group">
											...
											<div class="input-group">
											<span class="input-group-addon"><i class="icon-calendar"></i></span>
												<input type="text" class="form-control " name="tglfoto"  value="<?php echo date("m/d/Y",strtotime($this->docklist[0]["tglfoto"]))?>"  id="dp2" />
												
											</div>
										</div>
										<input type="hidden" class="form-control " name="tglupload"  value="<?php echo date("Y-m-d",strtotime($this->docklist[0]["tglupload"]))?>"  />
												<input type="hidden" class="form-control " name="pid" value="<?php echo $this->docklist[0]["ProductID"];?>"  />
