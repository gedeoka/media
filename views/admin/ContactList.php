                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php 
											if(Code::requery("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=12")<>0){
												$aImg=Code::GetField("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=12");											
											}
											?>
                                    <tbody>
									<?php
									foreach ($this->contactlist as $key => $value) {
                                        ...
                                        <tr class="odd gradeX">
											...
											<td nowrap><a class="btn btn-primary btn-circle" href="<?php echo URL;?>admin/editContact/<?php echo $value['CustomerID']; ?>-<?php echo $value['id']; ?>"><i class="icon-check"></i></a>
											<?php if ($aImg==1){?>
											<a class="btn btn-danger btn-circle" href="<?php echo URL;?>admin/DelContact/<?php echo $value['CustomerID']; ?>-<?php echo $value['id']; ?>"><i class="icon-remove"></i></a>
											<?php }?></td>
                                        </tr>
									<?php }?>
                                    </tbody>
