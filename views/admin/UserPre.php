                                ...
                                <div class="col-lg-12">
									...
									<?php 
										...
										if ($list["IDM"]==12){
											...
											<label class="checkbox-inline">
                                                <input type="checkbox" name="<?php echo $list['IDM'].'-del';?>" <?php if($list["Void"]==1){ echo "checked";}?>/>Remove Contact Person
                                            </label>
                                        </div>
									<?php 
										}
										...
										<div class="form-group">
											...
											<label class="checkbox-inline">
                                                <input type="checkbox" name="<?php echo $list['IDM'].'-del';?>" <?php if($list["Void"]==1){ echo "checked";}?>/>Delete/Void
                                            </label>
