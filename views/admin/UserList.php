                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$addi=Code::GetField("usrprev","AddIMG","IDUser='".Session::get('ID')."' and IDModule=13");											}
									if(Code::requery("usrprev","Kirim","IDUser='".Session::get('ID')."' and IDModule=13")<>0){
									$snd=Code::GetField("usrprev","Kirim","IDUser='".Session::get('ID')."' and IDModule=13");											}
									if(Code::requery("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=13")<>0){
									$chg=Code::GetField("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=13");											}
									if(Code::requery("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=13")<>0){
									$void=Code::GetField("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=13");											}
									foreach ($this->usrList as $key => $value) {
                                        ...
                                        <tr class="odd gradeX">
											...
											if($value['ID']<>'1'){
											if($void==1){?>
											<a class="btn btn-danger btn-circle" href="<?php echo URL;?>admin/UserDel/<?php echo $value['ID']; ?>"><i class="icon-remove"></i></a>
											<?php }}?></td>
