...
class admin extends Controllers{
	...
	public function ProductView($id){
		...
		$this->view->listPro=$this->model->PViewX($id);
	...
	public function DelContact($id){
		echo $id;
        $data=explode("-",$id);
        $this->model->DelContact($data[1]);
        header('location: '.URL.'admin/ContactList/'.$data[0]);
    }
	...
	public function kirimlokasiAdd(){
		$this->view->areals=$this->model->arealist();
		//$this->view->kotals=$this->model->kota();
	...
	public function updockEdit($id){
		
		$idx=Code::GetField("materi","ProductID","ID='".$id."'");
		//echo $idx;
		$this->view->prolist=$this->model->prosingle($idx);
		$this->view->docklist=$this->model->updocklst($id);
		$this->view->prolistkon=$this->model->prosinglekontrak($idx);
		$this->view->render('admin/updockEdit');
	}
	public function updockUpd($id){
		if(isset($id) || $id!=""){
			//$id=explode("-",$id);
	...
	public function listPDF(){
		...
		//$this->view->render('admin/vProd');
		$this->model->ProductViewx($xi);
	}
	public function relist(){
		$id=$_POST["dis"];
		$this->view->freeProperty=$this->model->FreeP($id);
	}
}
